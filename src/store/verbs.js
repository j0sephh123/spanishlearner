const verbs = {
  ...
  state: {    
    verbs: [
      {"id":1,  name: "ser", meaning   :"to be "},
      {"id":2,  name: "haber", meaning: "to have (to do something, auxiliary verb) "},
      {"id":3,  name: "estar", meaning: "to be (health, location, state) "},
      {"id":4,  name: "tener", meaning: "to have "},
      {"id":5,  name: "hacer", meaning: ""},
      {"id":6,  name: "poder", meaning: ""},
      {"id":7,  name: "decir", meaning: "to say, tell "},
      {"id":8,  name: "to", meaning: "go "},
      {"id":9,  name: "ver", meaning:  "to see"}, 
      {"id":10, name: "dar", meaning:  "to give"}, 
      {"id":11, name: "saber", meaning: "to know (information)"},
      {"id":12, name: "querer", meaning: "to want, love "},
      {"id":13, name: "llegar", meaning: "to arrive, come, reach "},
      {"id":14, name: "pasar", meaning: "to pass, to spend (time), to happen "},
      {"id":15, name: "deber", meaning: "to owe, must, should, ought to "},
      {"id":16, name: "poner", meaning: "to put, place, set "},
      {"id":17, name: "parecer", meaning: "to seem, appear "},
      {"id":18, name: "quedar", meaning: "to stay, remain "},
      {"id":19, name: "creer", meaning: "to believe "},
      {"id":20, name: "hablar", meaning: "to speak "},
      {"id":21, name: "llevar", meaning: "to carry, bring "},
      {"id":22, name: "dejar", meaning: "to leave, abandon, to let, allow "},
      {"id":23, name: "seguir", meaning: "to follow, continue "},
      {"id":24, name: "encontrar", meaning: "to find, encounter "},
      {"id":25, name: "llamar", meaning: "to call, to name "},
    ...
    search: '',
    watchedVideos: [
      {id: 1, link: 'https://www.youtube.com/watch?v=bUC_IwIEi68', title: 'Noticias Telemundo, 15 de septiembre de 2018 | Noticiero | Telemundo', type: 'noticias'},
      {id: 1, link: 'https://www.youtube.com/watch?v=bUC_IwIEi68', title: 'Noticias Telemundo, 15 de septiembre de 2018 | Noticiero | Telemundo', type: 'espanol automatico'},
    ]
  },
  mutations: {
    search(state, val) {
